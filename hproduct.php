...
if (isset($_GET['id'])) {
	...
	if($sql = $udit->query("SELECT * FROM handicraft WHERE id='$id' LIMIT 1")){;
      ...
      <div class="shop_top">
		<div class="container">
			<div class="single_image">
					 <img src="inventory_images/handicraft/<?php echo $id; ?>.jpg" style="display:inline;height:400px;width:300px;opacity:1;" />    
</div>
