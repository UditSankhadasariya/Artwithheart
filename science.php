...
if($sql = $udit->query("SELECT * FROM science ORDER BY date_added DESC LIMIT 6")){
}
$udit->close();
?>
...
<h1 style="text-align: center;margin-top: 77px">Science projects</h1>
  ...
  <div class="container-fluid"> 
    ...
    <div class="row">
      ...
      <div class="col-md-3" style="color: black;">
        ...
        <a href="sproduct.php?id=<?php echo $prod['id']; ?>"><img src="inventory_images/science/<?php echo $prod['id']; ?>.jpg" height="380px" width="263px"></a>
