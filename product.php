...
if (isset($_GET['id'])) {
	...
	if($sql = $udit->query("SELECT * FROM products WHERE id='$id' LIMIT 1")){;
      ...
      <div class="shop_top">
		<div class="container">
			<div class="single_image">
					 <img src="inventory_images/<?php echo $id; ?>.jpg" style="display:inline;height:400px;width:300px;opacity:1;" />    
</div>
                        <div class="single_right">
				        	<h1><?php echo $product_name; ?></h1><br />
                            <p class="price_prod">Price :- &#8377;<?php echo $price; ?></p><br />
                            <p class="m_10"><?php echo $dimensions; ?></p><br>
